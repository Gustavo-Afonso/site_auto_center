...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      {/* Header */}
      <header className="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm transition-shadow duration-300">
        <div className="container flex h-24 sm:h-28 items-center justify-between px-4 lg:px-8 mx-auto">

          {/* Logo */}
          <Link href="/" className="flex items-center transition-opacity duration-200 hover:opacity-85">
            <img src="/logo/AUTOCENTER.png" alt="WF Auto Center Logo" className="h-20 sm:h-24 w-auto" />
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-1">
            {navLinks.map((link) => (
              <a
                href={link.href}
                key={link.href}
                className="relative group px-3 py-2 rounded-md hover:bg-white/5 transition-colors duration-200"
              >
                <span className="text-sm font-medium text-gray-700 group-hover:text-orange-500 transition-colors duration-200">
                  {link.label}
                </span>
                <span className="absolute bottom-1 left-3 right-3 h-0.5 bg-orange-500 rounded-full scale-x-0 transition-transform duration-300 group-hover:scale-x-100" />
              </a>
            ))}
          </nav>
          ...
          <div className="hidden md:flex items-center">
            <a
              ...
              className="group relative overflow-hidden inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold text-sm px-5 py-2.5 rounded-lg shadow-lg shadow-orange-500/20 hover:shadow-orange-500/35 transition-all duration-300 hover:scale-105 whitespace-nowrap"
            >
          ...
          <button
            ...
            className="md:hidden flex items-center justify-center w-9 h-9 rounded-md hover:bg-gray-100 transition-colors duration-200"
            aria-expanded={isMobileMenuOpen}
            aria-label="Toggle mobile menu"
          >
            <span className="sr-only">Abrir menu</span>
            <div className="flex flex-col gap-1.5 w-5">
              <span className={`block h-0.5 bg-gray-800 rounded-full transition-all duration-300 origin-center ${isMobileMenuOpen ? 'rotate-45 translate-y-2' : ''}`} />
              <span className={`block h-0.5 bg-gray-800 rounded-full transition-all duration-300 ${isMobileMenuOpen ? 'opacity-0 scale-x-0' : ''}`} />
              <span className={`block h-0.5 bg-gray-800 rounded-full transition-all duration-300 origin-center ${isMobileMenuOpen ? '-rotate-45 -translate-y-2' : ''}`} />
            </div>
          </button>
        </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 shadow-lg">
            <div className="flex flex-col px-4 pt-2 pb-4 space-y-0.5">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="text-gray-700 hover:text-orange-500 hover:bg-orange-50 px-3 py-3 text-base font-medium rounded-md border-b border-gray-100 last:border-0 transition-colors duration-200"
              ...
              <div className="pt-3 pb-1">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-4 rounded-lg shadow-md transition-all duration-300"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="w-full relative overflow-hidden bg-zinc-950 py-12 sm:py-16 md:py-24 lg:py-32 xl:py-40">
          <div
            className="absolute inset-0 opacity-[0.04]"
            style={{ backgroundImage: 'radial-gradient(#f97316 1.5px, transparent 1.5px)', backgroundSize: '30px 30px' }}
          />
          <div className="absolute -top-24 -right-24 w-96 h-96 bg-orange-600 rounded-full blur-[130px] opacity-20 pointer-events-none" />
          <div className="absolute -bottom-24 -left-24 w-80 h-80 bg-orange-500 rounded-full blur-[100px] opacity-10 pointer-events-none" />
          ...
          <div className="container relative px-4 md:px-6 mx-auto">
            <div className="grid gap-8 items-center text-center lg:text-left lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-5 order-2 lg:order-1 mx-auto lg:mx-0 max-w-[600px] w-full">
                <div className="flex justify-center lg:justify-start">
                  <span className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/20 rounded-full px-4 py-1.5 text-orange-400 text-sm font-medium">
                ...
                <div className="space-y-3">
                  <h1 className="text-4xl text-white font-black tracking-tighter sm:text-5xl xl:text-7xl italic">
                    <span className="block">AUTO <span className="text-orange-500">CENTER</span></span>
                    <span className="block text-orange-500">WF <span className="text-white">LANTERNAGEM</span></span>
                  </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start pt-1">
                  <Link
                    href="#services"
                    className="inline-flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold px-6 py-3 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-orange-500/30"
                  >
                    Nossos Serviços
                  ...
                  <Link
                    href="#contact"
                    className="inline-flex items-center justify-center gap-2 border border-zinc-700 hover:border-orange-500/50 text-zinc-300 hover:text-orange-400 font-bold px-6 py-3 rounded-lg transition-all duration-300"
                  >
                    Agende uma Visita
                  </Link>
                </div>
              ...
              <div className="mb-6 lg:mb-0 order-1 lg:order-2 flex justify-center mx-auto w-full">
                <div className="w-full max-w-[260px] sm:max-w-[360px] lg:max-w-[310px] xl:max-w-[390px] relative">
                  <div className="absolute -inset-1.5 bg-gradient-to-br from-orange-500 to-orange-800 rounded-2xl blur-md opacity-50 pointer-events-none" />
                  <div className="relative">
                    <video
                      ref={videoRef}
                      className="overflow-hidden rounded-xl object-cover w-full h-auto shadow-2xl"
                      playsInline
                      preload="none"
                      poster="/videos/posters/videohero.jpg"
                      controls={isPlaying}
                    ...
                    {!isPlaying && (
                      <div
                        className="absolute inset-0 flex flex-col items-center justify-center cursor-pointer bg-black/20 rounded-xl"
                        onClick={handlePlayClick}
                      >
                        <div className="bg-orange-500 hover:bg-orange-600 rounded-full p-5 flex items-center justify-center shadow-2xl shadow-orange-500/50 transition-transform hover:scale-110">
                          <svg className="h-10 w-10 text-white ml-1" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M8 5v14l11-7z" />
                          </svg>
                        </div>
                        <span className="mt-4 font-semibold text-sm text-white bg-black/60 backdrop-blur-sm px-4 py-1.5 rounded-full">
        ...
        <section className="w-full bg-orange-500 py-8">
          <div className="container px-4 mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center">
              {[
                { number: '+500', label: 'Veículos Restaurados' },
                { number: '+10', label: 'Anos de Experiência' },
                { number: '100%', label: 'Satisfação Garantida' },
                { number: '6', label: 'Serviços Especializados' },
              ].map((stat) => (
                <div key={stat.label} className="flex flex-col items-center py-2">
                  <span className="text-3xl sm:text-4xl font-black text-white leading-none">{stat.number}</span>
                  <span className="text-orange-100 text-xs sm:text-sm font-medium mt-1">{stat.label}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Contact Section */}
        <section id="contact" className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-white to-orange-50">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-3">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight">
                  <span className="bg-orange-500 text-transparent bg-clip-text">Entre em Contato</span>
                </h2>
                <div className="h-1 w-32 bg-gradient-to-r from-orange-400 to-red-500 rounded-full mx-auto"></div>
            ...
            <div className="flex flex-col items-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative overflow-hidden bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-10 rounded-xl shadow-lg shadow-orange-500/30 transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3 w-full sm:w-auto"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                </svg>
                <span className="relative z-10 text-lg">Fazer Orçamento pelo WhatsApp</span>
                ...
                <div className="absolute inset-0 w-1/3 bg-gradient-to-r from-orange-400 to-transparent opacity-0 group-hover:opacity-30 group-hover:animate-shine"></div>
              </a>
